...
3- Escribimos git clone y agregamos la URL de este proyecto (https://github.com/BrunoFazz/Proyecto_Final.git)
...
6- Agregamos la palabra "core" al final del link: http://127.0.0.1:8000/core
